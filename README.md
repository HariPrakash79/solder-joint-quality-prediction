...
- **Decision threshold** controls how strict predictions are.
- For **classification** models, decision threshold is the probability cutoff.
- For **regression** models, decision threshold is applied to predicted void rate.
...
MobileNetV2 (fine-tuned + class weights):
